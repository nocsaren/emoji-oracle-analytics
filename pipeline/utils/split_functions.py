            ...
            pd.concat(
                [
                    ...
                    pd.DataFrame({
                        ...
                        'tutorial_completed': (df['event_params__tutorial_video'] == 'tutorial_video').astype(int) if 'event_params__tutorial_video' in df.columns else pd.Series(0, index=df.index),
